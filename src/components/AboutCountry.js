        ...
        <div>
           ...
           { props.desc&&
            ...
            <div className="desc-readmore">  
             ...
             <img src={props.desc[0].flags.png} className="img-sizing"></img>             
           ...
           <p>Google Map: <a href={props.desc[0].maps.googleMaps} className="link-sizing">{props.desc[0].maps.googleMaps}</a> </p>
